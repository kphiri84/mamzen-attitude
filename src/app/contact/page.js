    ...
    <div className="w-full">
      ...
      <section className="py-16 pt-24 bg-[#8A7BC8] text-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Contactez <span className="text-[#C3B1E1]">Break</span> <span className="text-[#F5F0FF]">Mums</span></h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Vous avez des questions sur nos lieux, vous souhaitez en savoir plus sur notre concept ou vous avez besoin d&apos;informations supplémentaires ? N&apos;hésitez pas à nous contacter, nous serons ravis de vous répondre.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@breakmums.fr</p>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-[#F5F0FF] hover:bg-[#F0E4FF] text-[#8A7BC8] p-3 rounded-full transition-colors">
            ...
            <div>
              <div className="bg-white rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold text-[#8A7BC8] mb-6">Envoyez-nous un <span className="text-[#A89CD7]">message</span></h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="reservation">Réservation d&apos;un séjour</option>
              ...
              <div className="mt-8 text-center">
                <Link href="/devis" className="inline-block bg-[#A89CD7] hover:bg-[#8A7BC8] text-white px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
      ...
      <section className="py-16 bg-[#F5F0FF]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#8A7BC8] mb-4">Questions <span className="text-[#A89CD7]">fréquentes</span></h2>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-[#8A7BC8] mb-3">Comment réserver un séjour ?</h3>
              <p className="text-gray-600">
                Pour réserver un séjour, rendez-vous sur la page &quot;Nos lieux&quot;, sélectionnez le lieu qui vous intéresse et cliquez sur le bouton &quot;Réserver&quot;. Vous serez guidé à travers le processus de réservation et de paiement.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Oui, vous pouvez annuler votre réservation jusqu&apos;à 30 jours avant la date de début du séjour avec un remboursement complet. Entre 30 et 15 jours, 50% du montant sera remboursé. Moins de 15 jours avant, aucun remboursement ne sera possible, mais vous pourrez reporter votre participation à une autre date.
              </p>
            </div>
            
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-[#8A7BC8] mb-3">Que dois-je apporter pour le séjour ?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Oui, tous les repas sont inclus dans le prix du séjour. Nous proposons une cuisine saine, équilibrée et majoritairement bio. Si vous avez des allergies ou des restrictions alimentaires, veuillez nous en informer lors de votre réservation.
              </p>
            </div>
